...
import { CartItem as CartItemType } from "@/redux/reducer";
import { useSelector } from "react-redux";

const Cart = () => {
  const state = useSelector((state: CartItemType[]) => state);
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="voucher"
                    className="focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 dark:focus:ring-primary-500 dark::text-gray-400 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                    required
                  />
                </div>
                <button
